package ru.veider.fooddelivery.presentation.basket
...
import ru.veider.fooddelivery.ru.veider.fooddelivery.presentation.basket.BasketAdapter
	...
	private fun workToBasket() {
		basketViewModel.basket.observe(viewLifecycleOwner) { productList ->
			if (productList.isNotEmpty()) {
				basketShimmer(false)
				val list = mutableListOf<BasketData>()
