package ru.veider.fooddelivery.presentation.ui.account.vm
...
class AccountViewModel(
	...
	private val _account = MutableLiveData<ScreenState<Account>>()
	fun getAccountData(): LiveData<ScreenState<Account>> {
